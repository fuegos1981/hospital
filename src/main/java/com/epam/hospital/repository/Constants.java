...
public class Constants {
    ...
    //person
    public static final String ADD_PERSON = "INSERT INTO person (last_Name,first_Name,birthday,email,gender_id) VALUES (?,?,?,?,?)";
    //patient
    ...
    //doctor
    public static final String GET_DOCTOR_BY_ID = "select doctor.id, person_id, last_Name,first_Name, birthday, email, gender.name as gender_name, category.name as category_name  from doctor " +
    ...
    public static final String GET_ALL_DOCTORS = "select doctor.id, person_id, last_Name,first_Name, birthday, email, gender.name as gender_name, category.name as category_name from doctor " +
            "join person on person.id=doctor.person_id " +
            "join category on category.id=doctor.category_id " +
    ...
    //medication
    public static final String GET_MEDICATION_BY_ID = "select * from medication where id= ?";
    ...
    //operation
    public static final String GET_OPERATION_BY_ID = "select * from operation where id= ?";
    ...
    //procedure
    public static final String GET_PROCEDURE_BY_ID = "select * from procedures where id= ?";
    public static final String GET_ALL_PROCEDURES = "select * from procedures order by name";
    public static final String ADD_PROCEDURE = "INSERT INTO procedures (name) VALUES (?)";
    public static final String DELETE_PROCEDURE = "DELETE from procedures where name= ?";
    ...
    public static String[] getQueries(String toString) {
        if (toString.equalsIgnoreCase(CATEGORY))
            return new String[]{GET_CATEGORY_BY_ID, GET_ALL_CATEGORIES,ADD_CATEGORY,DELETE_CATEGORY};
        else if(toString.equalsIgnoreCase(DIAGNOSIS))
            return new String[]{GET_DIAGNOSIS_BY_ID, GET_ALL_DIAGNOSISES,ADD_DIAGNOSIS,DELETE_DIAGNOSIS};
        else if(toString.equalsIgnoreCase(MEDICATION))
            return new String[]{GET_MEDICATION_BY_ID, GET_ALL_MEDICATIONES,ADD_MEDICATION,DELETE_MEDICATION};
        else if(toString.equalsIgnoreCase(OPERATION))
            return new String[]{GET_OPERATION_BY_ID, GET_ALL_OPERATIONES,ADD_OPERATION,DELETE_OPERATION};
        else if(toString.equalsIgnoreCase(PROCEDURE))
            return new String[]{GET_PROCEDURE_BY_ID, GET_ALL_PROCEDURES,ADD_PROCEDURE,DELETE_PROCEDURE};
